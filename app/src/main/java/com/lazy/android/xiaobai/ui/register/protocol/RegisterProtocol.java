 ...
 */
public class RegisterProtocol extends LZHttpProtocolHandlerBase {

	private UserInfoBean userInfoBean;

	public RegisterProtocol(Context context, LZHttpIProtocolCallback callBack, String username, String smscode, String pwd) {
		super(context, callBack);
		mSubUrl = mBaseUrl + "/usr/member!register.do";
		mProtocolType = ConfigProtocolType.REGISTER;
