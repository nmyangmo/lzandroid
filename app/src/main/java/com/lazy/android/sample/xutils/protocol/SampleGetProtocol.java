 ...
 */
public class SampleGetProtocol extends LZHttpProtocolHandlerBase {
	public String json;

	public SampleGetProtocol(Context context, LZHttpIProtocolCallback callBack) {
		super(context, callBack);
		mSubUrl = mTextUrl;
		mProtocolType = ConfigProtocolType.SAMPLE_GET;
