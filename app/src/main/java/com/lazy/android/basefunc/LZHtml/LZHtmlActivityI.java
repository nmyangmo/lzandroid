...
public class LZHtmlActivityI extends LZBaseActivityI {
...
//			onReceivedTitle
			mWebView.setWebChromeClient(new WebChromeClient(){
				...
				public void onProgressChanged(WebView view, int progress){
					...
					Toast.makeText(LZHtmlActivityI.this, "Loading....", Toast.LENGTH_SHORT).show();
					if(progress >= 80) {
						Toast.makeText(LZHtmlActivityI.this, "JsAndroid Test", Toast.LENGTH_SHORT).show();
					}
				}
			});
