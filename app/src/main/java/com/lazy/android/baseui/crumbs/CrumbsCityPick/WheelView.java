...
import com.lazy.android.baseui.crumbs.CrumbsCityPick.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.lz_crubs_citypicker_wheel_bg;
	private int wheelForeground = R.drawable.lz_crubs_citypicker_wheel_val;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.blue_09aaa5));
		// 设置线宽
