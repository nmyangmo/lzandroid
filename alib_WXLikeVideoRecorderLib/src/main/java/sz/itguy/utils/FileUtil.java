...
//                Environment.DIRECTORY_PICTURES), "MyCameraApp");
    ...
    public static String createImgPath(String folder, String subfolder, String uniqueId) {
        File dir = new File(Environment.getExternalStorageDirectory(), folder);
        if (subfolder != null) {
            dir = new File(dir, subfolder);
        }
        dir.mkdirs();
        String fileName = Constants.FILE_START_NAME + uniqueId + Constants.VIDEOIMG_EXTENSION;
        return new File(dir,fileName).getAbsolutePath();
    }
